 <%@page import="academia.model.entities.Profesor"%>
<%@page import="java.util.ArrayList"%>
<%@page import="academia.controller.profesores.ProfesorForm"%>
...
Profesor formulario= (Profesor)request.getAttribute("formulario");
if (errores==null){
                                    ...
                                    <form role="form" action="./modificar.html" method="post">
                                       <input type="hidden" value="<%=formulario.getId()%>" name="id"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="telefono" class="form-control" type="text" value="<%=formulario.getTlf()%>">
                                            <p class="help-block"></p>
                                        </div>
                                        <div class="form-group">
                                            <label>Correo</label>
